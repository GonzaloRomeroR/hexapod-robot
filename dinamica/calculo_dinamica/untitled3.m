...
l1 = 1; l2 = 1; l3 = 1;
q1 = 2; q2 = 1; q3 = 1;
qd1 = 2; qd2 = 0.1; qd3 = 0.1;
qdd1 = 0.01; qdd2 = 10; qdd3 = 0.01;
...
RotMatrix(:, :, 1) = [cos(q1), -sin(q1) * cos(0), sin(q1) * sin(0); sin(q1), cos(q1) * cos(0), -cos(q1) * sin(0); 0, sin(0), cos(0)];
RotMatrix(:, :, 2) = [cos(q2), -sin(q2) * cos(0), sin(q2) * sin(0); sin(q2), cos(q2) * cos(0), -cos(q2) * sin(0); 0, sin(0), cos(0)];
RotMatrix(:, :, 3) = [cos(q2), -sin(q2) * cos(0), sin(q2) * sin(0); sin(q2), cos(q2) * cos(0), -cos(q2) * sin(0); 0, sin(0), cos(0)];
RotMatrix(:, :, 4) = [1, 0, 0; 0, 1, 0; 0, 0, 1];
