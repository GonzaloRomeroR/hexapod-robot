...
J1 = [m1 * lc1 ^ 2, 0, 0, lc1*m1; 0, 0, 0, 0; 0, 0, 0, 0; lc1*m1 0 0 m1];
J2 = [m2 * lc2 ^ 2, 0, 0, lc2*m2; 0, 0, 0, 0; 0, 0, 0, 0; lc2*m2 0 0 m2];
J3 = [m3 * lc3 ^ 2, 0, 0, lc3*m3; 0, 0, 0, 0; 0, 0, 0, 0; lc3*m3 0 0 m3];
%%Pseudoinercias
